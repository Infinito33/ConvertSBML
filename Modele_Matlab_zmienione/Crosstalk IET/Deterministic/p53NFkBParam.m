%##################################################
%                                                 #
% p53-NFkB deterministic simulations - parameters #
%                                                 #
% KP 02.03.2009                                   #
%                                                 #
%##################################################
...
%di - degradation rate
    ...
    d0=0.3*10^-4;   % 035*10^-4  MDM2 standard degradation rate
...
%##############################################################
    ...
    d10=2*10^-4;    %(5*10^-4 JTB) (2*10^-4 IET) p53 transcript degradation 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
